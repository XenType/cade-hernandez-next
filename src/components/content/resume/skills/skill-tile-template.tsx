  ...
  return (
    ...
    >
      <div className="flex flex-col space-y-2">
        <div className="text-cade-blue-lite md:text-lg font-bold">Mastery</div>
        <div className="text-xl md:text-3xl font-bold">{getMasteryText()}</div>
        <div>
      ...
      <div className="flex flex-col space-y-2">
        ...
        <div className="text-cade-blue-lite md:text-lg font-bold">
          Experience
        </div>
      </div>
    </div>
