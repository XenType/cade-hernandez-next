  ...
  return (
    <div className="flex w-full bg-cade-blue-dark/10">
      <div className="max-w-[1000px] m-auto flex flex-col h-full">
        <div className="w-full flex flex-row justify-center text-center text-xs md:text-lg font-bold p-2 space-x-4 md:space-x-0">
          <div
        ...
        <div className="flex flex-col h-full pb-2 pt-2 md:pt-6 items-center justify-center min-h-[475px] grow px-2">
          {entryKeyState &&
          ...
          endYearState ? (
            ...
            <div className="flex flex-col space-y-1 xl:space-y-4 items-center grow md:min-w-[800px] bg-white rounded-lg shadow shadow-cade-blue-dark/20 p-1 md:py-4 md:px-2 md:mb-4">
              <div className="pt xl:pt-2 text-sm md:text-base xl:text-lg font-semibold">
                Experience That Spans Three Career Paths
              </div>
              <div className="px-2 max-w-[600px] flex flex-col space-y-1 md:space-y-2 text-xs xl:text-sm">
