...
const EventGroupCard: React.FC<EventGroupCardProps> = ({
  ...
  return (
    <div className="bg-cade-blue-dark rounded-md shadow-lg border border-cade-blue-med shadow-cade-blue-med/50 z-5 w-[170px] md:w-[350px] flex flex-col space-y-2 pb-2">
      <div className="flex flex-col z-5">
        <div className="flex flex-row justify-between w-full items-center text-white">
          ...
          <div className="hidden md:flex pr-4 text-xs">{yearRange}</div>
        </div>
