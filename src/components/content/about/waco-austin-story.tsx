  ...
  return (
    <AboutMeStoryCard title="Waco & Austin, TX" className="austin-background">
      <div className="flex flex-col space-y-2 md:space-y-4 xl:space-y-8 text-sm md:text-base">
        <div>
          I worked for a year in Waco before enrolling at the local community
          college. I did well balancing my full course load with a part-time job
          with a single, terrible exception: I slept through an important test
          and got a D in a very easy introductory course. Lesson learned!
        </div>
        <div>
          I also discovered more and more about myself while living in this
          mid-sized city. I came out to my friends first, and eventually my
          family. I also found that I wanted to have more freedom than a 7 to 4
          office job allowed, so I tried out freelance work and did some
          restaurant work to fill in the gaps in income that come from contract
          work.
        </div>
        <div>
