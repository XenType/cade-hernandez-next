  ...
  return (
    <div className="flex flex-col space-y-4 px-8">
      ...
      <div className="text-justify text-sm font-semibold">
        ...
        working on one of the world's largest online sales platforms, my career
        has had an e-commerce theme throughout.
      </div>
      <div className="text-justify text-sm font-semibold">
        <Indentation />I had the good fortune to work for a small company that
        was attempting to blaze new trails in the budding e-commerce domain. The
        leadership team had a steady flow of innovative new products for us to
        create and our small team of very green developers (myself included!)
        rose to each challenge using every tool at our disposal.
      </div>
      <div className="text-justify text-sm font-semibold">
        <Indentation />
        During a period of time when I was more focused on a career in
        hospitality and management - only taking on small website contracts - I
        did complete a large project that I consider a career milestone:
        Creating a brandable webinar platform for a very interesting client.
      </div>
      <div className="text-justify text-sm font-semibold">
        <Indentation />
