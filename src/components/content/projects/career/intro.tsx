  ...
  return (
    <div className="flex flex-col space-y-2 md:space-y-4 p-2 md:px-8 h-full">
      ...
      <div className="flex flex-col space-y-2 md:space-y-4 overflow-y-auto px-2">
        ...
        <div className="text-justify text-sm font-semibold">
          I had the good fortune to work for a small company that was attempting
          to blaze new trails in the budding e-commerce domain. The leadership
          team had a steady flow of innovative new products for us to create and
          our small team of very green developers (myself included!) rose to
          each challenge using every tool at our disposal.
        </div>
        <div className="text-justify text-sm font-semibold">
